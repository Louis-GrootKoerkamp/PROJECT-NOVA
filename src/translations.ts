export const translations = {
  en: {
    ...
    team: {
      ...
      title_part2: "Your",
      title_part3: "Team",
      description: "The Utrecht team is small, but we're loud. We build things that matter for the shops next door.",
      roles: {
        design: "Design Lead",
        tech: "Tech Wizard",
        strategy: "Strategy"
    ...
    howWeRoll: {
      ...
      cards: {
        crafted: {
          title: "Hand-Crafted",
          desc: "Every pixel is placed with intent and care. We pour our hearts into building digital experiences that feel human."
        },
        fluff: {
          title: "No Fluff",
          desc: "Zero corporate speak. Just high-fidelity craft that actually moves the needle."
        },
        community: {
          title: "Community",
        ...
        results: {
          title: "Results First",
          desc: "We focus on ROI, conversions, and growth—not just pretty pixels."
        }
      }
    },
    work: {
      title_code: "The Code",
      title_part2: "The",
      title_canvas: "The Canvas.",
      description: "Forget the technical jargon. We handle the heavy lifting under the hood so you only have to care about the beautiful, revenue-generating result.",
      label_ordering: "Online Presence",
      label_transformation: "Digital Transformation",
  ...
  nl: {
    ...
    team: {
      ...
      title_part2: "Team",
      title_part3: "",
      description: "Het Utrechtse team is klein, zo houden we het contact persoonlijk en doelgericht. samen werken we eraan om jouw droom te realiseren.",
      roles: {
        design: "Design Boss",
        tech: "Tech Wizard",
        strategy: "Strategisch Brein"
      }
    },
    reviews: {
      title_part1: "Echte",
    ...
    howWeRoll: {
      ...
      cards: {
        ...
        fluff: {
          ...
          desc: "Nul corporate praatjes. Alleen hoogwaardig vakmanschap dat ook echt resultaat oplevert."
        },
        community: {
          title: "Community",
        ...
        results: {
          ...
          desc: "We focussen op ROI, conversies en groei—niet alleen op mooie plaatjes."
        }
      }
    },
    work: {
